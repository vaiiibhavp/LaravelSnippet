          ...
          <div class="card-body px-lg-5 py-lg-5">
            <form role="form" method="post" action="<?php echo e(route('extras.store', $item)); ?>" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="variantsSelector"><?php echo e(__('Select variant or leave empty for all')); ?></label>
                <br />
...
<div class="container mt--7">
  <div class="row">
      ...
      <div class="card bg-secondary shadow">
        <div class="card-header bg-white border-0">
          <div class="row align-items-center">
            ...
            <div class="col-4 text-right"> <?php if(auth()->user()->hasRole('owner')): ?> <a href="<?php echo e(route('items.index')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Back to items')); ?></a> <?php elseif(auth()->user()->hasRole('admin')): ?> <a href="<?php echo e(route('items.admin', $restorant)); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Back to items')); ?></a> <?php endif; ?> </div>
          </div>
        </div>
        <br/>
          ...
          <div class="pl-lg-4">
            ...
            <div class="text-center">
              <form action="<?php echo e(route('items.destroy', $item)); ?>" method="post">
                ...
                <button type="button" class="btn btn-danger mt-4" onclick="confirm('<?php echo e(__("Are you sure you want to delete this item?")); ?>') ? this.parentElement.submit() : ''">
    ...
    <!-- <div class="col-xl-6 mb-6 mb-xl-0"> <br/>
      ...
      <div class="card card-profile shadow">
        <div class="card-header">
          <div class="row align-items-center">
            ...
            <div class="col-6 text-right"> <a class="btn btn-secondary btn-sm" href="<?php echo e(route('items.options.index',$item->id)); ?>"><?php echo e(__('Edit Options')); ?></a> <a class="btn btn-success btn-sm" href="<?php echo e(route('items.variants.create',['item'=>$item->id])); ?>"><?php echo e(__('Add Variant')); ?></a> </div>
          </div>
        </div>
        <div class="card-body"> <?php echo $__env->make('items.variants.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          <table class="table align-items-center">
            <thead class="thead-light">
              <tr>
                ...
                <?php if($item->has_variants==1): ?>
                <th scope="col"><?php echo e(__('For')); ?></th>
                <?php endif; ?>
                <th scope="col"></th>
              </tr>
            </thead>
            ...
            <tr>
              ...
              <?php if($item->has_variants==1): ?>
              <td class="budget"><?php echo e($extra->extra_for_all_variants?__('All variants'):__('Selected')); ?></td>
              <?php endif; ?>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/items/edit.blade.php ENDPATH**/ ?>