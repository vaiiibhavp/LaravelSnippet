                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h2 class="text-white mb-0">Gross Sales Value</h2>
                            </div>
                            <div class="col-auto">
                                <div class="filterbtn-div leftchart-div">
                                    <a href="?graphfilter=last30days" class="btn btn-info">Last 30 Days</a>
                                    <a href="?graphfilter=last7days" class="btn btn-info">Last 7 Days</a>
                                    <a href="?graphfilter=todays" class="btn btn-info">Today's</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4">
                <div class="card shadow">
                    <div class="card-header bg-transparent">
                     ...
                     <!--    <div class="row align-items-center">
                            <div class="col">
                              <div class="filterbtn-div rightchart">
                                 <a href="?graphfilter=last30days" class="btn btn-info">Last 30 Days</a>
                                    <a href="?graphfilter=last7days" class="btn btn-info">Last 7 Days</a>
                                    <a href="?graphfilter=todays" class="btn btn-info">Today's</a>
                              </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <!-- Google Map -->
    <script async defer src= "https://maps.googleapis.com/maps/api/js?libraries=geometry,drawing&callback=initDriverMap&key=AIzaSyD2GvdJWaoF0gp6zYVKruGHgLSYLETS1b4"> </script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/dashboard.blade.php ENDPATH**/ ?>