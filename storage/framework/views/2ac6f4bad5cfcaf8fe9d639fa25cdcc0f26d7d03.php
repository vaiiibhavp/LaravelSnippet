    ...
    <div class="container-fluid">
        ...
        <div class="nav-wrapper">
            <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="res_menagment" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0 active " id="tabs-menagment-main" data-toggle="tab" href="#menagment" role="tab" aria-controls="tabs-menagment" aria-selected="true"><i class="ni ni-badge mr-2"></i><?php echo e(__('Chef Management')); ?></a>
                </li>
                        ...
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    ...
                                    https://zipeat.in/index.php/restorants/<?php echo e($restorant->subdomain); ?>" class="btn btn-sm btn-success"><?php echo e(__('View it')); ?></a>
                                    <?php else: ?>
                                    <!-- <a target="_blank" href="<?php echo e(route('vendor',$restorant->subdomain)); ?>" -->
                                    <a target="_blank" href="
                                    https://zipeat.in/index.php/restorants/<?php echo e($restorant->subdomain); ?>"
...
<script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD2GvdJWaoF0gp6zYVKruGHgLSYLETS1b4&callback=initAutocomplete&libraries=places,geometry,drawing&v=weekly"
        async
></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/restorants/edit.blade.php ENDPATH**/ ?>