                    ...
                    <div class="card bg-secondary shadow border-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            <form id="form-assing-driver" method="GET" action="">
                                ...
                                <input type="hidden" id="ot" name="ot" value="">
                                <div class="text-center">
...
<?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/orders/partials/modals.blade.php ENDPATH**/ ?>