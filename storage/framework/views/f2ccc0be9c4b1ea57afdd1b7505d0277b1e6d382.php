<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('varietybundle.partials.header', ['title' => 'Edit Variety Bundle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <style type="text/css">
    [draggable] {
...
.column.over {
  ...
  <div class="row">
      ...
      <div class="card bg-secondary shadow">
          ...
          <div class="pl-lg-4">
              <form method="post" action="/verietybundleupdate" autocomplete="off" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              <input type="hidden" name="id" value="<?php  echo $varietybundle[0]['id']; ?>">
              <div class="form-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                    <label class="form-control-label" for="name">Title</label>
                    <input type="text" name="name" id="name" class="form-control form-control-alternative<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" placeholder="Variety Bundle Title ..." value="<?php  echo $varietybundle[0]['title']; ?>" required autofocus>
              ...
              <div class="row mb-4">
                  ...
                  <div class="form-group">
                     ...
                     <?php  if($chef['id'] == $bundledetail['chef_id']){ echo "selected"; } ?>
                  ...
                  <div class="form-group">
                      ...
                      <?php $__currentLoopData = $food_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($food_type['id']); ?>"
                         <?php  if($food_type['id'] == $bundledetail['food_type_id']){ echo "selected"; } ?>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control form-control-alternative select-width" name="user_diet_id[]">
                          ...
                          <?php $__currentLoopData = $diets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php  if($diet['id'] == $bundledetail['user_diet_id']){ echo "selected"; } ?>
                  ...
                  <div class="form-group">
                        ...
                        <input type="number" name="days[]" id="name" class="form-control form-control-alternative days" placeholder="Enter Days ..." value="<?=$bundledetail['days']?>" required autofocus>
                      </div>
                </div>
                    <div class="col-lg-3 col-md-4">
                      <div class="form-group">
                        <label class="form-control-label" for="name">Price</label>
                        <input type="text" name="price[]" id="name" class="form-control form-control-alternative prices" placeholder="Enter Price ..." value="<?=$bundledetail['price']?>" required autofocus onkeypress="return isNumberKey(event)">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="commission[]" id="name" class="form-control form-control-alternative commissions" placeholder="Enter Commission ..." value="<?=$bundledetail['commission']?>" onkeypress="return isNumberKey(event)" required autofocus>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="delivery_time[]" id="name" class="form-control form-control-alternative " placeholder="Enter delivery time ..." value="<?=$bundledetail['delivery_time']?>"  required autofocus>
                      </div>
                    </div>

                    <?php
                    $images=[
                        ['name'=>'bundle_image[]','label'=>__('Slider Image'),'value'=>asset('storage/'.$bundledetail['bundle_image']),'style'=>'width: 200px; height: 100px;']
                          ]
                  ?>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                          ...
                          <textarea  class="form-control form-control-alternative" rows="4" cols="50" name="food_items[]"><?=$bundledetail['food_items']?></textarea>
                        </div>
                  </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                    
              ...
              <div class="row mb-4" >
                          ...
                          <tr>
                            ...
                            <tbody id="columns">
                               ...
                               <tr class="column" draggable="true">
                                 <td><?php echo e($bs['chefname']); ?></td>
                                 <td><?php echo e($bs['seq_deilvery']); ?> Delivery</td>
                               </tr>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
                          </table>
                  ...
                  <div class="row align-items-center">
                      <div class="col-xl-4 col-md-5 col-12">
                        <ul class="totamtday">
                              <li>Total Day - <span id="total_days"><?php  echo $varietybundle[0]['total_days']; ?></span>
                                <input type="hidden" value="<?php  echo $varietybundle[0]['gross_value']; ?>" name="gross_value" id="gross_value"/>
                                  <input type="hidden" value="<?php  echo $varietybundle[0]['total_days']; ?>" name="final_days" id="final_days"/>
                              </li>
                              <li>Total Amount - <span id="total_amount"><?php  echo $varietybundle[0]['gross_value']; ?></span>
                                <input type="hidden" value="<?php  echo $varietybundle[0]['total_commission']; ?>" name="total_commission" id="total_commission"/>
                              </li>
                        </ul>
                      </div>
                      <div class="col-md-4 col-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="discount" id="name" class="form-control form-control-alternative" placeholder="Enter Discount ..." value="<?php  echo $varietybundle[0]['discount']; ?>" required autofocus>
                        </div>
                      </div>
  ...
  // $('#seqbtn').hide();
   ...
   function add_sequence() {
    ...
    total_days = 0;
     ...
     $('#total_amount').html(total_commissions+total_prices);
     $('#gross_value').val(total_commissions+total_prices);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', ['title' => __('Variety_Bundles')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/varietybundle/editverietybundle.blade.php ENDPATH**/ ?>