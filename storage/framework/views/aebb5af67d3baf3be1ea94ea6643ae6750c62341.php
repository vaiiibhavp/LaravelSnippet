    ...
    <div class="text-center">
        <div class="fileinput fileinput-new" data-provides="fileinput">
            ...
            <div>
                ...
                <input type="file" name="<?php echo e($image['name']); ?>" accept="image/x-png,image/gif,image/jpeg" class="<?php if(isset($editclass)): ?><?php echo e($editclass); ?><?php endif; ?>" <?php if(isset($val)): ?> val="<?php echo e($val); ?>" <?php endif; ?> >
                </span>
                <a href="#" class="btn btn-outline-secondary fileinput-exists" data-dismiss="fileinput"><?php echo e(__('Remove')); ?></a>
            </div>
        </div>
    </div>
</div><?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/partials/images.blade.php ENDPATH**/ ?>