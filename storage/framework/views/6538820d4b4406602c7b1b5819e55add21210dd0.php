            ...
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                    ...
                    <!-- <div class="form-group login-input"> -->
                     <!-- <label class="form-control-label" for="name">Search</label> -->
                     <!-- <input type="text" style="width:100% !important;" class="form-control form-control-alternative" placeholder="Search Location ..." value="" required autofocus> -->
                     <!-- </div> -->
...
<?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/restorants/partials/location.blade.php ENDPATH**/ ?>