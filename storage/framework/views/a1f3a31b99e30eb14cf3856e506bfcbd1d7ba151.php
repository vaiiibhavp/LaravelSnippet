...
<div class="pl-lg-4">
    ...
    <div class="form-group<?php echo e($errors->has('email_owner') ? ' has-danger' : ''); ?>">
        ...
        <input type="text" name="email_owner" id="email_owner" class="form-control form-control-alternative" placeholder="<?php echo e(__('Chef Email')); ?>" value="<?php echo e(old('name', $restorant->user->email)); ?>" readonly>
    </div>
    <div class="form-group<?php echo e($errors->has('phone_owner') ? ' has-danger' : ''); ?>">
        ...
        <input type="text" name="phone_owner" id="phone_owner" class="form-control form-control-alternative" placeholder="<?php echo e(__('Chef Phone')); ?>" value="<?php echo e(old('name', $restorant->user->phone)); ?>" readonly>
    </div>
</div>
<?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/restorants/partials/owner.blade.php ENDPATH**/ ?>