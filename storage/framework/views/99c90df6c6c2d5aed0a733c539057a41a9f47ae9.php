...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('custom')); ?>/css/datatables.css">
        
        <!-- Boostrap Select -->
        
        <link type="text/css" href="<?php echo e(asset('custom')); ?>/css/bootstrap-datetimepicker.css" rel="stylesheet">
        <link type="text/css" href="<?php echo e(asset('custom')); ?>/css/bootstrap-select.css" rel="stylesheet">

        <!-- Swiper Slider Css -->
        <link type="text/css" href="<?php echo e(asset('custom')); ?>/css/swiper.min.css" rel="stylesheet">
    ...
    <body class="<?php echo e($class ?? ''); ?>">
        ...
        <script src="<?php echo e(asset('custom')); ?>/js/bootstrap-datetimepicker.js"></script>
        ...
        <!-- Bootstrap Select -->
        <script src="<?php echo e(asset('custom')); ?>/js/bootstrap-select.js"></script>

        <!-- Swiper Slider Js -->
        <script src="<?php echo e(asset('custom')); ?>/js/swiper.min.js"></script>
        ...
        <!-- Datatable Select -->
        <script src="<?php echo e(asset('custom')); ?>/js/datatables.js"></script>
        ...
        <!-- Validation Js -->
         <script src="<?php echo e(asset('custom')); ?>/js/validation.js"></script>
...
<?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/layouts/app.blade.php ENDPATH**/ ?>