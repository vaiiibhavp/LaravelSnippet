    ...
    <div class="container mt--6 pb-5">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body shadow-white px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-danger' : ''); ?> mb-3">
                                <div class="input-group input-group-alternative login-input">
...
<?php echo $__env->make('layouts.app', ['class' => 'bg'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nk6nzmf8mf9q/public_html/fdadmin.prometteur.in/resources/views/auth/login.blade.php ENDPATH**/ ?>