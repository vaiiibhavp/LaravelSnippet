<ul class="navbar-nav">
    @if(config('app.ordering'))
        ...
        <!--  <li class="nav-item">
            <a class="nav-link" href="{{ url('/todayitems') }}">
    ...
    @endif
       ...
       <!--  <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/verietybundlelist')}}">
            <i class="fa fa-cutlery" aria-hidden="true"></i> Variety Bundles
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/offerslist')}}">
        ...
        @endif -->
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/chefreviewlist') }}">
            <i class="ni ni-diamond text-info"></i> {{ __('Reviews') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/websliderlist') }}">
                <i class="fa fa-picture-o text-success"></i> Web Slider
            </a>
        </li>        
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/foodtypes') }}">
                <i class="fa fa-picture-o text-success"></i> Categories
            </a>
        </li>       
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/diets') }}">
                <i class="fa fa-picture-o text-success"></i> Diets
            </a>
        </li>     
        <!-- <li class="nav-item">
            <a class="nav-link" href="{{ url('/packagingoptions') }}">
