...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link type="text/css" href="{{ asset('custom') }}/css/bootstrap-datetimepicker.css" rel="stylesheet">
        <link type="text/css" href="{{ asset('custom') }}/css/bootstrap-select.css" rel="stylesheet">

        <!-- Swiper Slider Css -->
        <link type="text/css" href="{{ asset('custom') }}/css/swiper.min.css" rel="stylesheet">
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <!-- Bootstrap Select -->
        <script src="{{ asset('custom') }}/js/bootstrap-select.js"></script>
        ...
        <!-- Datatable Select -->
        <script src="{{ asset('custom') }}/js/datatables.js"></script>
